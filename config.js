...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "VORTEX-MD",  // Bot's display name
    MODE: getConfig("MODE") || process.env.MODE || "public",        // Bot mode: public/private/group/inbox
    REPO: process.env.REPO || "https://github.com/VORTEX-MD/VORTEX-MD",  // Bot's GitHub repo
    BAILEYS: process.env.BAILEYS || "@whiskeysockets/baileys",  // Bot's BAILEYS

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94713713687",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "MR YESHULA",           // Owner's name
    DEV: process.env.DEV || "94713713687",                     // Developer's contact number
    DEVELOPER_NUMBER: '94713713687@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*VORTEX BOT VIEWED YOUR STATUS.💗*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "VORTEX-MD",     // Sticker pack name
    ...
    BOT_IMAGE: getConfig("BOT_IMAGE") || "https://files.catbox.moe/21bl4v.jpg",  // Bot's "alive" image
    ...
    FOOTER: process.env.FOOTER || "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ Vᴏʀᴛᴇx*",  // Bot description
